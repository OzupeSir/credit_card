...
def sentiment_score_list(dataset):
    ...
    for sen in seg_sentence: #循环遍历每一个评论
        segtmp=jieba.lcut(sen,cut_all=False) #句子分词，以列表形式返回
        i=0 #记录扫描到的词的位置
        a=0 #记录情感词的位置
...
if __name__=='__main__':
    data='挺好的 运行速度：运行速度快 通信音质：通话音量挺大，完全够用了 电池续航：续航能力可以，比之前的xsmax好一些，可能之前屏幕比较大，这个可以 拍照效果：拍照效果很好 其他特色：颜色很好看，很适合女生，哈哈哈，手机大小拿着也刚好，之前xsmax太大了点，这个尺寸很合适'
